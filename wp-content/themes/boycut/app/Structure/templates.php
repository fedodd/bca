...
use function boycut\App\template;
...
add_action('theme/index/post/thumbnail', 'boycut\App\Structure\render_post_thumbnail');
...
add_action('theme/index/content/none', 'boycut\App\Structure\render_empty_content');
...
add_action('theme/single/content', 'boycut\App\Structure\render_post_content');
...
add_action('theme/index/sidebar', 'boycut\App\Structure\render_sidebar');
add_action('theme/single/sidebar', 'boycut\App\Structure\render_sidebar');
...
add_action('theme/header/end', 'boycut\App\Structure\render_documentation_button');
