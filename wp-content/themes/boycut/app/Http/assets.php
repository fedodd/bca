...
use function boycut\App\asset_path;
...
add_action('wp_enqueue_scripts', 'boycut\App\Http\register_stylesheets');
...
add_action('wp_enqueue_scripts', 'boycut\App\Http\register_scripts');
...
add_action('admin_init', 'boycut\App\Http\register_editor_stylesheets');
...
add_action('wp_default_scripts', 'boycut\App\Http\move_jquery_to_the_footer');
