...
add_filter('theme/index/sidebar/visibility', 'boycut\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'boycut\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'boycut\App\Setup\modify_excerpt_length');
