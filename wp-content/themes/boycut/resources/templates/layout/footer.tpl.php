        <footer class="footer">
          <div class="holder footer-wrapper">
            <div class="footer-line">
              <span class="footer-text">Boy Cut Academy. Since 2018</span>
              <span class="footer-text"><?php echo get_field("footer-adress", 83)?></span>
            </div>
            <div class="footer-line">
            ...
            <div class="footer-line is__alt">
              ...
              <a href="<?php echo get_field("footer-insta", 83)?>" class="footer-link is__hidden">boycut_academy</a>
            </div>
          </div>
        </footer>        
        <?php wp_footer(); ?>
        <script type="text/javascript" src="uploads/jquery-1.11.0.min.js"></script>
        <script type="text/javascript" src="uploads/jquery-migrate-1.2.1.min.js"></script>
        <script type="text/javascript" src="uploads/slick.min.js"></script>
        <script type="text/javascript" src="uploads/magnific.js"></script>
